...
<details>
<summary>더보기: K8S는 왜 dockershim을 제거했을까?</summary>
...
| 리포지토리 | 설명 | 링크 |
|---|---|---|
| image-spec | 컨테이너 이미지 디스크 포맷 | [GitHub](https://github.com/opencontainers/image-spec) |
| image-tools | OCI 이미지 명세에 따라 동작하는 도구 모음 | [GitHub](https://github.com/opencontainers/image-tools) |
| runtime-spec | 컨테이너의 설정 방법, 실행 환경, 라이프사이클을 명시 | [GitHub](https://github.com/opencontainers/runtime-spec) |
| runtime-tools | OCI 런타임 명세에 따라 동작하는 도구 모음 | [GitHub](https://github.com/opencontainers/runtime-tools) |
| runc | OCI 표준에 따라 컨테이너를 생성하고 실행할 수 있는 명령형 도구 | [GitHub](https://github.com/opencontainers/runc) |
| go-digest | 컨테이너 생태계에서 광범위하게 활용될 수 있는 공통 다이제스트 패키지 | [GitHub](https://github.com/opencontainers/go-digest) |
| selinux | 컨테이너에 범용적으로 적용될 수 있는 SELinux 설정 | [GitHub](https://github.com/opencontainers/selinux) |
